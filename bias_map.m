...
box off
surfm(AS_GPH.lat,AS_GPH.lon,AS_GPH.CCA.bias)
caxis([-0.11 0.11])
colormap(jet(22))
...
geoshow(worldland,'FaceColor',[.9 .9 .9],'LineWidth',0.6)
box off
surfm(AS_GPH.lat,AS_GPH.lon,AS_PPT.CCA.bias)
caxis([-0.11 0.11])
colormap(jet(22))
subplotsqueeze(gca,1.6)
...
geoshow(worldland,'FaceColor',[.9 .9 .9],'LineWidth',0.6)
box off
surfm(AS_GPH.lat,AS_GPH.lon,AS_TEMP.CCA.bias)
caxis([-0.11 0.11])
colormap(jet(22))
subplotsqueeze(gca,1.6)
...
geoshow(worldland,'FaceColor',[.9 .9 .9],'LineWidth',0.6)
box off
surfm(AS_GPH.lat,AS_GPH.lon,OM_GPH.CCA.bias)
caxis([-0.11 0.11])
colormap(jet(22))
subplotsqueeze(gca,1.6)
...
geoshow(worldland,'FaceColor',[.9 .9 .9],'LineWidth',0.6)
box off
surfm(AS_GPH.lat,AS_GPH.lon,OM_PPT.CCA.bias)
caxis([-0.11 0.11])
colormap(jet(22))
subplotsqueeze(gca,1.6)
...
geoshow(worldland,'FaceColor',[.9 .9 .9],'LineWidth',0.6)
box off
surfm(AS_GPH.lat,AS_GPH.lon,OM_TEMP.CCA.bias)
caxis([-0.11 0.11])
colormap(jet(22))
subplotsqueeze(gca,1.6)
...
geoshow(worldland,'FaceColor',[.9 .9 .9],'LineWidth',0.6)
box off
surfm(AS_GPH.lat,AS_GPH.lon,AS_GPH.RegEM.bias)
caxis([-0.11 0.11])
colormap(jet(22))
subplotsqueeze(gca,1.6)
...
geoshow(worldland,'FaceColor',[.9 .9 .9],'LineWidth',0.6)
box off
surfm(AS_GPH.lat,AS_GPH.lon,AS_PPT.RegEM.bias)
caxis([-0.11 0.11])
colormap(jet(22))
subplotsqueeze(gca,1.6)
...
geoshow(worldland,'FaceColor',[.9 .9 .9],'LineWidth',0.6)
box off
surfm(AS_GPH.lat,AS_GPH.lon,AS_TEMP.RegEM.bias)
caxis([-0.11 0.11])
colormap(jet(22))
subplotsqueeze(gca,1.6)
...
geoshow(worldland,'FaceColor',[.9 .9 .9],'LineWidth',0.6)
box off
surfm(AS_GPH.lat,AS_GPH.lon,OM_GPH.RegEM.bias)
caxis([-0.11 0.11])
colormap(jet(22))
subplotsqueeze(gca,1.6)
...
geoshow(worldland,'FaceColor',[.9 .9 .9],'LineWidth',0.6)
box off
surfm(AS_GPH.lat,AS_GPH.lon,OM_PPT.RegEM.bias)
caxis([-0.11 0.11])
colormap(jet(22))
subplotsqueeze(gca,1.6)
...
geoshow(worldland,'FaceColor',[.9 .9 .9],'LineWidth',0.6)
box off
surfm(AS_GPH.lat,AS_GPH.lon,OM_TEMP.RegEM.bias)
caxis([-0.11 0.11])
colormap(jet(22))
subplotsqueeze(gca,1.6)
...
geoshow(worldland,'FaceColor',[.9 .9 .9],'LineWidth',0.6)
box off
surfm(AS_GPH.lat,AS_GPH.lon,AS_GPH.PPR.bias)
caxis([-0.11 0.11])
colormap(jet(22))
subplotsqueeze(gca,1.6)
...
geoshow(worldland,'FaceColor',[.9 .9 .9],'LineWidth',0.6)
box off
surfm(AS_GPH.lat,AS_GPH.lon,AS_PPT.PPR.bias)
caxis([-0.11 0.11])
colormap(jet(22))
subplotsqueeze(gca,1.6)
...
geoshow(worldland,'FaceColor',[.9 .9 .9],'LineWidth',0.6)
box off
surfm(AS_GPH.lat,AS_GPH.lon,AS_TEMP.PPR.bias)
caxis([-0.11 0.11])
colormap(jet(22))
subplotsqueeze(gca,1.6)
...
geoshow(worldland,'FaceColor',[.9 .9 .9],'LineWidth',0.6)
box off
surfm(AS_GPH.lat,AS_GPH.lon,OM_GPH.PPR.bias)
caxis([-0.11 0.11])
colormap(jet(22))
subplotsqueeze(gca,1.6)
...
geoshow(worldland,'FaceColor',[.9 .9 .9],'LineWidth',0.6)
box off
surfm(AS_GPH.lat,AS_GPH.lon,OM_PPT.PPR.bias)
caxis([-0.11 0.11])
colormap(jet(22))
subplotsqueeze(gca,1.6)
...
geoshow(worldland,'FaceColor',[.9 .9 .9],'LineWidth',0.6)
box off
surfm(AS_GPH.lat,AS_GPH.lon,OM_TEMP.PPR.bias)
caxis([-0.11 0.11])
colormap(jet(22))
subplotsqueeze(gca,1.6)
