setwd('C:/Users/Matthew/Desktop/C-TRES/Climate')

aseig<-read.table('AS_Climate_fullz_PC.csv',header=F,sep=',')
omeig<-read.table('OM_Climate_fullz_PC.csv',header=F,sep=',')
