...
box off
surfm(AS_GPH.lat,AS_GPH.lon,AS_GPH.CCA.r)
caxis([-.6 .6])
colormap(jet(22))
...
geoshow(worldland,'FaceColor',[.9 .9 .9],'LineWidth',0.6)
box off
surfm(AS_GPH.lat,AS_GPH.lon,AS_PPT.CCA.r)
caxis([-.6 .6])
colormap(jet(22))
subplotsqueeze(gca,1.6)
...
geoshow(worldland,'FaceColor',[.9 .9 .9],'LineWidth',0.6)
box off
surfm(AS_GPH.lat,AS_GPH.lon,AS_TEMP.CCA.r)
caxis([-.6 .6])
colormap(jet(22))
subplotsqueeze(gca,1.6)
...
geoshow(worldland,'FaceColor',[.9 .9 .9],'LineWidth',0.6)
box off
surfm(AS_GPH.lat,AS_GPH.lon,OM_GPH.CCA.r)
caxis([-.6 .6])
colormap(jet(22))
subplotsqueeze(gca,1.6)
...
geoshow(worldland,'FaceColor',[.9 .9 .9],'LineWidth',0.6)
box off
surfm(AS_GPH.lat,AS_GPH.lon,OM_PPT.CCA.r)
caxis([-.6 .6])
colormap(jet(22))
subplotsqueeze(gca,1.6)
...
geoshow(worldland,'FaceColor',[.9 .9 .9],'LineWidth',0.6)
box off
surfm(AS_GPH.lat,AS_GPH.lon,OM_TEMP.CCA.r)
caxis([-.6 .6])
colormap(jet(22))
subplotsqueeze(gca,1.6)
...
geoshow(worldland,'FaceColor',[.9 .9 .9],'LineWidth',0.6)
box off
surfm(AS_GPH.lat,AS_GPH.lon,AS_GPH.RegEM.r)
caxis([-.6 .6])
colormap(jet(22))
subplotsqueeze(gca,1.6)
...
geoshow(worldland,'FaceColor',[.9 .9 .9],'LineWidth',0.6)
box off
surfm(AS_GPH.lat,AS_GPH.lon,AS_PPT.RegEM.r)
caxis([-.6 .6])
colormap(jet(22))
subplotsqueeze(gca,1.6)
...
geoshow(worldland,'FaceColor',[.9 .9 .9],'LineWidth',0.6)
box off
surfm(AS_GPH.lat,AS_GPH.lon,AS_TEMP.RegEM.r)
caxis([-.6 .6])
colormap(jet(22))
subplotsqueeze(gca,1.6)
...
geoshow(worldland,'FaceColor',[.9 .9 .9],'LineWidth',0.6)
box off
surfm(AS_GPH.lat,AS_GPH.lon,OM_GPH.RegEM.r)
caxis([-.6 .6])
colormap(jet(22))
subplotsqueeze(gca,1.6)
...
geoshow(worldland,'FaceColor',[.9 .9 .9],'LineWidth',0.6)
box off
surfm(AS_GPH.lat,AS_GPH.lon,OM_PPT.RegEM.r)
caxis([-.6 .6])
colormap(jet(22))
subplotsqueeze(gca,1.6)
...
geoshow(worldland,'FaceColor',[.9 .9 .9],'LineWidth',0.6)
box off
surfm(AS_GPH.lat,AS_GPH.lon,OM_TEMP.RegEM.r)
caxis([-.6 .6])
colormap(jet(22))
subplotsqueeze(gca,1.6)
...
geoshow(worldland,'FaceColor',[.9 .9 .9],'LineWidth',0.6)
box off
surfm(AS_GPH.lat,AS_GPH.lon,AS_GPH.PPR.r)
caxis([-.6 .6])
colormap(jet(22))
subplotsqueeze(gca,1.6)
...
geoshow(worldland,'FaceColor',[.9 .9 .9],'LineWidth',0.6)
box off
surfm(AS_GPH.lat,AS_GPH.lon,AS_PPT.PPR.r)
caxis([-.6 .6])
colormap(jet(22))
subplotsqueeze(gca,1.6)
...
geoshow(worldland,'FaceColor',[.9 .9 .9],'LineWidth',0.6)
box off
surfm(AS_GPH.lat,AS_GPH.lon,AS_TEMP.PPR.r)
caxis([-.6 .6])
colormap(jet(22))
subplotsqueeze(gca,1.6)
...
geoshow(worldland,'FaceColor',[.9 .9 .9],'LineWidth',0.6)
box off
surfm(AS_GPH.lat,AS_GPH.lon,OM_GPH.PPR.r)
caxis([-.6 .6])
colormap(jet(22))
subplotsqueeze(gca,1.6)
...
geoshow(worldland,'FaceColor',[.9 .9 .9],'LineWidth',0.6)
box off
surfm(AS_GPH.lat,AS_GPH.lon,OM_PPT.PPR.r)
caxis([-.6 .6])
colormap(jet(22))
subplotsqueeze(gca,1.6)
...
geoshow(worldland,'FaceColor',[.9 .9 .9],'LineWidth',0.6)
box off
surfm(AS_GPH.lat,AS_GPH.lon,OM_TEMP.PPR.r)
caxis([-.6 .6])
colormap(jet(22))
subplotsqueeze(gca,1.6)
